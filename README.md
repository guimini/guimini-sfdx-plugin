...
running command...
$ sfdx (--version)
@gaelmotte/gmotte-sfdx-plugin/0.3.0-alpha.1 linux-x64 node-v19.0.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/org/switch.ts](https://github.com/gaelmotte/gmotte-sfdx-plugin/blob/v0.3.0-alpha.1/src/commands/org/switch.ts)_
<!-- commandsstop -->
